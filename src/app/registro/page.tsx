          ...
          {phoneInUseError && (
            <div className="border border-red-500/20 bg-red-500/5 text-stone-800 dark:text-stone-200 rounded-xl p-5 text-xs space-y-3.5 animate-fadeIn">
              ...
              <div className="flex flex-col gap-2 pt-1">
                ...
                <a
                  href={language === 'en'
                    ? `https://wa.me/50660677055?text=Hello!%20I%20am%20trying%20to%20register%20on%20TicoHabitat%20with%20the%20number%20${duplicatePhone}%20but%20it%20says%20it%20is%20already%2520in%2520use.%20Could%20you%20help%20me?%20My%20name%2520is%2520${encodeURIComponent(name || '[My Name]')}.`
                    : `https://wa.me/50660677055?text=Hola!%20Estoy%20intentando%20registrarme%20en%20TicoHabitat%20con%20el%20número%20${duplicatePhone}%20pero%20indica%20que%20ya%20está%2520en%2520uso.%20¿Me%20podrían%20ayudar?%20Mi%20nombre%2520es%2520${encodeURIComponent(name || '[Mi Nombre]')}.`}
                  target="_blank"
                  rel="noreferrer"
