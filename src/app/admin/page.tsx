  ...
  if (!session || session.role !== 'ADMIN') {
    return (
      <div className="flex-grow flex flex-col items-center justify-center p-12 text-center hero-gradient min-h-[60vh]">
        <h1 className="text-3xl font-extrabold text-red-500">Acceso Denegado</h1>
        ...
        <Link href="/login" className="bg-slate-900 hover:bg-slate-850 text-white font-semibold px-6 py-3 rounded-2xl shadow">
    ...
    <div className="flex-grow bg-slate-50/50 dark:bg-slate-900/10 py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 mb-6">
          <span>Inicio</span>
          <span>/</span>
          <span className="text-slate-600 dark:text-slate-350 font-semibold">Administración</span>
        </div>
        ...
        <div className="mb-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="font-display text-3xl font-extrabold text-slate-900 dark:text-white flex items-center justify-center sm:justify-start gap-2">
              <span>Panel de Moderación & Métricas</span>
            </h1>
          ...
          >
            ...
            <span>Monetización (Pagos SINPE)</span>
          </Link>
        </div>
