    ...
    '@graph': [
      {
        ...
        'potentialAction': {
          ...
          'target': {
            '@type': 'EntryPoint',
            'urlTemplate': `https://ticohabitat.com/${lang}/comprar?search={search_term_string}`
          },
      ...
      <section className="relative py-32 lg:py-44 border-b border-stone-250/30 dark:border-stone-900/80 hero-gradient">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center space-y-10">
          ...
          <h1 className="font-display text-4xl sm:text-7xl font-extrabold tracking-tight text-stone-900 dark:text-white max-w-4xl mx-auto leading-tight sm:leading-[1.08]">
            {t.home.heroTitlePart1}<span className="text-primary italic font-medium font-serif font-light text-emerald-900 dark:text-sky-355">{t.home.heroTitleItalic}</span>
          </h1>
          
          <p className="text-base sm:text-lg text-stone-550 dark:text-stone-400 max-w-2xl mx-auto leading-relaxed font-semibold">
            {t.home.heroSubtitle}
          </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-14">
          {featuredItems.length === 0 ? (
            <div className="flex flex-col items-center justify-center text-center p-16 bg-card-bg border border-card-border rounded-2xl shadow-sm">
              ...
              <Link href={`/${lang}/publicar`} className="btn-primary py-3 px-6 text-xs transition-all shadow shadow-sm active:scale-95">
