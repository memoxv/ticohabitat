...
const FAQ_ITEMS_EN = [
  {
    category: 'Publish & Manage',
    questions: [
      {
        q: 'How do I publish a property on TicoHabitat?',
        a: 'Log into your account, click "Publish" in the main menu, and fill out the form with your property details: type (sale or rent), location, price, photos, and contact info. Your listing will be active immediately.',
      },
      {
        q: 'How much does it cost to publish a listing?',
        a: 'Publishing a basic listing on TicoHabitat is completely free. We only charge if you choose to feature your listing so it appears in the platform\'s premium sections.',
      },
      {
        q: 'How long does my listing remain active?',
        a: 'Listings are active for 30 days. When they expire, they are automatically marked as expired. You can renew them from your control panel at any time.',
      },
      {
        q: 'Can I edit my listing after publishing it?',
        a: 'Yes. From your control panel (Dashboard), you can edit the title, description, price, photos, and any details of your property at any time while the listing is active.',
      },
      {
        q: 'How many photos can I upload per listing?',
        a: 'You can upload multiple photos per listing. We recommend including at least 3 high-quality photos showing the main spaces of the property.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: 'Why am I asked to verify my email?',
        a: 'Email verification (via secure link or 6-digit OTP code) is mandatory before publishing. This ensures that every listing has a real owner behind it, eliminates spam, and protects buyers and tenants from fake listings.',
      },
      {
        q: 'What if I do not receive the verification email?',
        a: 'Check your spam or junk folder. Make sure the registered email is correct. You can request to resend the link or OTP code from the publishing screen. If the problem persists, contact us on WhatsApp for help.',
      },
      {
        q: 'Is it safe to share my phone number?',
        a: 'Your contact number is only shown on your listing so interested users can contact you directly. We do not share your data with third parties or use it for advertising.',
      },
      {
        q: 'How do you prevent duplicate listings?',
        a: 'Our system automatically detects duplicates or suspicious listings using quality filters. If a listing is identified as a duplicate, the owner is notified to take action.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        a: 'A featured listing appears in the "Premium Recommendations" sections at the top of the buy or rent page. This gives your property much more visibility to thousands of visitors.',
      },
      {
        q: 'How much does it cost to feature a listing?',
        a: 'Featuring prices vary depending on the plan you choose. You can see the available options from your control panel in the "Feature" section. We currently offer affordable rates for individual owners.',
      },
      {
        q: 'How long does the feature last?',
        a: 'The duration depends on the selected plan. It generally ranges from 7 to 30 days. Once expired, your listing remains active but goes back to the regular list.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        a: 'You can browse by province from the "Buy" or "Rent" sections. Each province shows active listings with filters by property type, price, and features.',
      },
      {
        q: 'Can I save properties as favorites?',
        a: 'Yes. If you have an active account, you can mark properties as favorites by clicking the heart icon. You will find them later in your control panel.',
      },
      {
        q: 'How do I contact the owner?',
        a: 'Each listing includes a button for direct contact via WhatsApp or phone. Communication is always direct between you and the owner, without intermediaries or commissions.',
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: 'Do I need an account to search for properties?',
        a: 'No. You can browse and see all listings without registering. You only need to create an account if you want to publish a listing, save favorites, or feature properties.',
      },
      {
        q: 'How do I recover my password?',
        a: 'On the login screen, click "Forgot your password?". We will send a recovery link to your registered email address.',
      },
      {
        q: 'How do I contact support?',
        a: 'You can write directly to us via WhatsApp at +506 6067-7055. Our team handles inquiries Monday through Saturday in Costa Rica time.',
      },
    ],
  },
];
  ...
  return (
    <div className="border-b border-stone-200/50 dark:border-stone-850/50 last:border-b-0">
      ...
      >
        ...
        <ChevronDown
          className={`h-4 w-4 shrink-0 text-stone-400 dark:text-stone-555 transition-transform duration-200 ${
    ...
    <div className="flex-grow bg-stone-50/20 dark:bg-stone-950/20 py-16">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-xs font-bold text-stone-400 dark:text-stone-555 mb-8 uppercase tracking-wider">
          <Link href={`/${language}`} className="hover:text-primary transition-colors">{t.common.home}</Link>
          <span>/</span>
        ...
        <div className="text-left mb-14 max-w-2xl">
          ...
          <p className="text-sm font-medium text-stone-500 dark:text-stone-400 mt-4 leading-relaxed">
            {isEn
              ? 'Answers to the most common questions about publishing, searching, and featuring properties on TicoHabitat.'
        ...
        <div className="mt-16 p-8 rounded-2xl border border-stone-200/50 dark:border-stone-850 bg-white dark:bg-stone-900/40 text-center space-y-4">
          <h3 className="font-display font-extrabold text-lg text-stone-900 dark:text-white">
            {isEn ? 'Didn\'t find the answer you were looking for?' : '¿No encontraste la respuesta que buscabas?'}
          </h3>
          <p className="text-xs text-stone-550 dark:text-stone-400 max-w-md mx-auto leading-relaxed">
            {isEn
              ? 'Our support team is ready to help. Message us directly on WhatsApp and we will get back to you as soon as possible.'
          ...
          >
            ...
            <span>{isEn ? 'Message us on WhatsApp' : 'Escribir por WhatsApp'}</span>
          </a>
        </div>
      </div>
    </div>
