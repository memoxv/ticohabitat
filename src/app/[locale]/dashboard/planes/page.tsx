      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 mb-6">
          ...
          <span className="text-slate-600 dark:text-slate-350">
            {locale === 'en' ? 'Plans & Pricing' : 'Planes y Precios'}
          </span>
        </div>
        ...
        <div className="mb-10 text-center sm:text-left">
          <h1 className="font-display text-3xl font-extrabold text-slate-900 dark:text-white">
            {locale === 'en' ? 'Listing Plans and Subscriptions' : 'Planes de Publicación y Suscripciones'}
          </h1>
          <p className="text-sm text-slate-500 mt-1">
            {locale === 'en'
              ? 'Improve your visibility, publish unlimited listings, and position your real estate brand in Costa Rica.'
