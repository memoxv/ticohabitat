    ...
    return (
      <div className="flex-grow flex flex-col items-center justify-center p-12 text-center hero-gradient min-h-[60vh]">
        ...
        <p className="text-slate-500 mt-2 mb-6 max-w-sm">
          {locale === 'en' 
            ? 'You do not have sufficient permissions to edit this listing. Only the owner or a moderator can make modifications.' 
        ...
        >
          {locale === 'en' ? 'Back to Dashboard' : 'Volver al Panel'}
        </a>
      </div>
    );
  }
